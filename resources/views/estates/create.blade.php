...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <form class="form-horizontal" role="form" method="POST" action="{{ route('estates.store') }}">
            ...
            <div class="form-group{{ $errors->has('Condos') ? ' has-error' : '' }}">
                <label for="notes" class="col-md-4 control-label">Tipo de Condomino</label>

                <div class="col-md-6">
                    <select name="type_of_estate" class="form-control">
            ...
            <div class="form-group{{ $errors->has('Condos') ? ' has-error' : '' }}">
                <label for="notes" class="col-md-4 control-label">Condominio</label>
